...
<p>An integer <code>n</code> is a power of three, if there exists an integer <code>x</code> such that <code>n == 3<sup style="">x</sup></code>.</p>
...
<strong>Explanation:</strong> 27 = 3<sup style="">3</sup>
</pre>
...
<strong>Explanation:</strong> There is no x where 3<sup style="">x</sup> = 0.
</pre>
...
<strong>Output:</strong> false
<strong>Explanation:</strong> There is no x where 3<sup style="">x</sup> = (-1).
</pre>
