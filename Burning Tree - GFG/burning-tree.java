...
class Solution
{
    ...
    public static int minTime(Node root, int target) 
    {
        ...
        int time = findMaxDist(parents, start);
        return time;
    }
    
    public static int findMaxDist(Map<Node, Node> parents, Node start) {
    ...
    public static Node markParents(Node root, Map<Node, Node> parents, int target) {
        Queue<Node> queue = new LinkedList<>();
